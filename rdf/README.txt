...
Showing top 10 nodes out of 31 (cum >= 8566234)
  ...
  55529704 26.71% 26.71%   55529704 26.71%  gopkg.in/adibiarsotp/dgraph.v0/rdf.Parse
  28255068 13.59% 40.30%   30647245 14.74%  gopkg.in/adibiarsotp/dgraph.v0/posting.(*List).getPostingList
  ...
  17582839  8.46% 67.13%   17706815  8.52%  gopkg.in/adibiarsotp/dgraph.v0/loader.(*state).readLines
  15139047  7.28% 74.41%   88445933 42.55%  gopkg.in/adibiarsotp/dgraph.v0/loader.(*state).parseStream
  12927366  6.22% 80.63%   12927366  6.22%  github.com/zond/gotomic.(*element).search
  10789028  5.19% 85.82%   66411362 31.95%  gopkg.in/adibiarsotp/dgraph.v0/posting.GetOrCreate
   9453856  4.55% 90.37%    9453856  4.55%  github.com/zond/gotomic.(*hashHit).search
   8566234  4.12% 94.49%    8566234  4.12%  gopkg.in/adibiarsotp/dgraph.v0/uid.stringKey


(pprof) list rdf.Parse
Total: 207887723
ROUTINE ======================== gopkg.in/adibiarsotp/dgraph.v0/rdf.Parse in /home/mrjn/go/src/gopkg.in/adibiarsotp/dgraph.v0/rdf/parse.go
...
Showing top 10 nodes out of 62 (cum >= 18180150)
 ...
 103445194 18.46% 18.46%  103445194 18.46%  github.com/Sirupsen/logrus.(*Entry).WithFields
  ...
  48366300  8.63% 38.77%  203838187 36.37%  gopkg.in/adibiarsotp/dgraph.v0/posting.(*List).get
  39789719  7.10% 45.87%   49276181  8.79%  gopkg.in/adibiarsotp/dgraph.v0/posting.(*List).getPostingList
  36642638  6.54% 52.41%   36642638  6.54%  gopkg.in/adibiarsotp/dgraph.v0/lex.NewLexer
  ...
  18546971  3.31% 72.22%   72863016 13.00%  gopkg.in/adibiarsotp/dgraph.v0/loader.(*state).parseStream
  18090764  3.23% 75.45%   18180150  3.24%  gopkg.in/adibiarsotp/dgraph.v0/loader.(*state).readLines
...
Showing top 10 nodes out of 52 (cum >= 161.50MB)
      flat  flat%   sum%        cum   cum%
  304.56MB 17.95% 17.95%   304.56MB 17.95%  gopkg.in/adibiarsotp/dgraph.v0/posting.NewList
  ...
  207.55MB 12.23% 42.54%   417.10MB 24.58%  github.com/Sirupsen/logrus.(*Entry).WithField
     108MB  6.37% 48.90%      108MB  6.37%  gopkg.in/adibiarsotp/dgraph.v0/uid.(*lockManager).newOrExisting
   ...
   78.01MB  4.60% 63.73%    78.01MB  4.60%  gopkg.in/adibiarsotp/dgraph.v0/posting.Key
   78.01MB  4.60% 68.32%    78.51MB  4.63%  gopkg.in/adibiarsotp/dgraph.v0/uid.stringKey
