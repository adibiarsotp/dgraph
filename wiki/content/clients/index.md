...
The proto file used by Dgraph is located at [graphresponse.proto](https://github.com/adibiarsotp/dgraph/blob/master/protos/graphp/graphresponse.proto).
...
```
go get -u -v github.com/adibiarsotp/dgraph/client github.com/adibiarsotp/dgraph/protos
```
