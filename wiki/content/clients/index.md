...
Go clients can use the clients package and communicate with the server over [gRPC](http://www.grpc.io/).  Internally this uses [Protocol Buffers](https://developers.google.com/protocol-buffers) and the proto file used by Dgraph is located at [graphresponse.proto](https://gopkg.in/adibiarsotp/dgraph.v82/blob/master/protos/graphresponse.proto).
...
Go get the client:
```
go get -u -v gopkg.in/adibiarsotp/dgraph.v82/client
```

#### Examples

The client [GoDoc](https://godoc.org/gopkg.in/adibiarsotp/dgraph.v82/client) has specifications of all functions and examples.

Larger examples can be found [here](https://gopkg.in/adibiarsotp/dgraph.v82/tree/master/wiki/resources/examples/goclient).  And [this](https://open.dgraph.io/post/client0.8.0) blog post explores the examples further.

The app [dgraph-live-loader](https://gopkg.in/adibiarsotp/dgraph.v82/tree/master/cmd/dgraph-live-loader) uses the client interface to batch concurrent mutations.
