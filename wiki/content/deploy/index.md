...
If you don't want to follow the automatic installation method, you could manually download the appropriate tar for your platform from **[Dgraph releases](https://gopkg.in/adibiarsotp/dgraph.v83/releases)**. After downloading the tar for your platform from Github, extract the binaries to `/usr/local/bin` like so.
...
Nightly builds from Dgraph master branch at https://gopkg.in/adibiarsotp/dgraph.v83 are available from https://nightly.dgraph.io.  To install run:
...
go get -u gopkg.in/adibiarsotp/dgraph.v83/...
```
...
* [Product Roadmap to v1.0](https://gopkg.in/adibiarsotp/dgraph.v83/issues/1)
