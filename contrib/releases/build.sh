...
# go build from inside $GOPATH/src/gopkg.in/adibiarsotp/dgraph.v0/cmd/dgraph
...
dgraph_cmd=$GOPATH/src/gopkg.in/adibiarsotp/dgraph.v0/cmd;
ui="/usr/local/share/dgraph/assets"

release="gopkg.in/adibiarsotp/dgraph.v0/x.dgraphVersion"
branch="gopkg.in/adibiarsotp/dgraph.v0/x.gitBranch"
commitSHA1="gopkg.in/adibiarsotp/dgraph.v0/x.lastCommitSHA"
commitTime="gopkg.in/adibiarsotp/dgraph.v0/x.lastCommitTime"
uiDir="main.uiDir"
...
cd $cur_dir
GZIP=-n tar -zcf assets.tar.gz -C $GOPATH/src/gopkg.in/adibiarsotp/dgraph.v0/dashboard/build .
