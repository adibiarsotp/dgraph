...
# go build from inside $GOPATH/src/gopkg.in/adibiarsotp/dgraph.vo/cmd/dgraph
...
dgraph_cmd=$GOPATH/src/gopkg.in/adibiarsotp/dgraph.vo/cmd;
ui="/usr/local/share/dgraph/assets"

release="gopkg.in/adibiarsotp/dgraph.vo/x.dgraphVersion"
branch="gopkg.in/adibiarsotp/dgraph.vo/x.gitBranch"
commitSHA1="gopkg.in/adibiarsotp/dgraph.vo/x.lastCommitSHA"
commitTime="gopkg.in/adibiarsotp/dgraph.vo/x.lastCommitTime"
uiDir="main.uiDir"
...
cd $cur_dir
GZIP=-n tar -zcf assets.tar.gz -C $GOPATH/src/gopkg.in/adibiarsotp/dgraph.vo/dashboard/build .
