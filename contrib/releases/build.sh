...
# go build from inside $GOPATH/src/gopkg.in/adibiarsotp/dgraph.v82/cmd/dgraph
...
cd $cur_dir
GZIP=-n tar -zcf assets.tar.gz -C $GOPATH/src/gopkg.in/adibiarsotp/dgraph.v82/dashboard/build .
