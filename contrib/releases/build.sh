...
# go build from inside $GOPATH/src/gopkg.in/adibiarsotp/dgraph.v83/cmd/dgraph
...
cd $cur_dir
GZIP=-n tar -zcf assets.tar.gz -C $GOPATH/src/gopkg.in/adibiarsotp/dgraph.v83/dashboard/build .
