...
NIGHTLY_FILE="${GOPATH}/src/gopkg.in/adibiarsotp/dgraph.v81/${TAR_FILE}"
SHA_FILE_NAME="dgraph-checksum-${OS}-amd64-${DGRAPH_VERSION}${ASSET_SUFFIX}.sha256"
SHA_FILE="${GOPATH}/src/gopkg.in/adibiarsotp/dgraph.v81/${SHA_FILE_NAME}"
ASSETS_FILE="${GOPATH}/src/gopkg.in/adibiarsotp/dgraph.v81/assets.tar.gz"
...
build_docker_image() {
	...
	pushd ${GOPATH}/src/gopkg.in/adibiarsotp/dgraph.v81/contrib/nightly > /dev/null
